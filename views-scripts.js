...
const getViewScripts = (protocol, host) => {
    return `
            ...
            reader.onload = async function(e) {
                try {
                    ...
                    if (config.resolver_update_interval) {
                        ...
                        // Cria um campo oculto no form se não existe já
                        ...
                        // Pianifica l'aggiornamento do resolver
        ...
        async function downloadPythonScript() {
            ...
            // Salva l'URL no campo nascosto do form
        ...
        async function executePythonScript() {
            try {
                ...
                if (data.success) {
                    alert('Script eseguido con successo!');
        ...
        async function scheduleUpdates() {
            ...
            // Salva l'intervallo no campo nascosto do form
