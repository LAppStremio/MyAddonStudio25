...
app.get('/manifest.json', async (req, res) => {
    try {
        ...
        const manifestConfig = {
            ...
            behaviorHints: {
                // Isto remove o botão de engrenagem
                configurable: false,
                // Isto define a URL de configuração protegida
...
app.post('/api/resolver', async (req, res) => {
    ...
    try {
        if (action === 'download' && url) {
            ...
            res.json({ 
                success: true, 
                message: stopped ? 'Aggiornamento automatico fermato' : 'Nessun aggiornamento pianificado da fermare' 
            });
        } else {
