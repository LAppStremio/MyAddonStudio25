...
// Rota principal para a página de configuração, que verifica o código de acesso
...
app.get('/manifest.json', async (req, res) => {
    try {
        ...
        // ALTERAÇÃO CRUCIAL AQUI: remove a engrenagem e fornece a URL protegida
        const configUrl = `${protocol}://${host}/?access_code=${process.env.ACCESS_CODE}`;
        
        // Verifica se a URL M3U foi passada e reconstrói o cache, se necessário
        ...
        const manifestConfig = {
            ...
            behaviorHints: {
                // Definição crucial para remover o ícone de engrenagem
                configurable: false,
...
app.get('/:config/manifest.json', async (req, res) => {
    try {
        ...
        const manifestConfig = {
            ...
            behaviorHints: {
                // AQUI, manteremos 'true' para os casos em que o utilizador já está a usar a URL com o hash
                configurable: true,
