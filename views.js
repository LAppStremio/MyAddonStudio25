...
const renderConfigPage = (protocol, host, query, manifest) => {
    ...
    // O conteúdo só será visível se houver um código de acesso e ele for o correto
    const accessCodeCorrect = query.access_code === process.env.ACCESS_CODE;
    
    // A visibilidade do conteúdo depende apenas do código de acesso.
    // Se o access_code não existir ou for incorreto, o conteúdo fica invisível.
                    ...
                    <div class="advanced-settings">
                        ...
                        <div class="advanced-settings-content" id="python-section-content">
                            <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 4px; margin-bottom: 20px; margin-top: 15px;">
                                ...
                                <p><strong>Nota:</strong> L'URL deve puntare a uno script Python que genera um file M3U.</p>
                            </div>
                            <div id="pythonForm">
                    ...
                    <div class="advanced-settings">
                        ...
                        <div class="advanced-settings-content" id="resolver-section-content">
                            <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 4px; margin-bottom: 20px; margin-top: 15px;">
                                ...
                                <ul style="text-align: left;">
                                    <li>Risolvere dinamicamente gli URL de streaming</li>
