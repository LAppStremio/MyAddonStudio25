...
const renderConfigPage = (protocol, host, query, manifest) => {
    ...
    // Se o código for correto, o conteúdo fica visível
    const contentVisible = accessCodeCorrect || showConfigFields;
    
    // Adiciona o código de acesso a todos os links da página, se ele for válido
    const persistentQuery = { ...query };
    if (accessCodeCorrect) {
        persistentQuery.access_code = query.access_code;
    }
        ...
        <body>
            <div class="content">
                ...
                <div class="manifest-url">
                    ...
                    ${protocol}://${host}/manifest.json?${new URLSearchParams(persistentQuery)}
                </div>
                ...
                <div style="margin-top: 30px; text-align: center; font-size: 14px; color: #ccc;">
                    ${contentVisible && showSupportSection ? `
