    ...
    return `
        ...
        <body>
            <div class="content">
                ...
                <div class="config-form" id="access-form">
                    <h2>Introduza o código de acesso</h2>
                    <div style="display: flex; gap: 10px;">
                        <input type="password" id="accessCode" placeholder="Insira o código aqui" style="flex: 1;">
                        <button onclick="checkAccessCode()">DESBLOQUEAR</button>
                    </div>
                </div>

                <div id="hidden-content" class="hidden-section">
                ...
                <script>
                    ...
                    // Novo script para a validação do código de acesso
                    function checkAccessCode() {
                        const correctCode = 'MEUTV2024';
                        const enteredCode = document.getElementById('accessCode').value;

                        if (enteredCode === correctCode) {
                            document.getElementById('access-form').style.display = 'none';
                            document.getElementById('hidden-content').classList.remove('hidden-section');
                        } else {
