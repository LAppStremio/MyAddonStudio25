...
const m3uDefaultUrl = 'https://github.com/LAppStremio/MyAddonStudio25/blob/main/tv.png?raw=true';
const showConfigFields = process.env.SHOW_CONFIG_FIELDS === 'true';
const showSupportSection = process.env.SHOW_SUPPORT_SECTION === 'true'; // Nova variável adicionada aqui
...
/* Alterado de 'purple' para o gradiente cinza */
          }
          #background-video {
              position: fixed;
right: 0;
