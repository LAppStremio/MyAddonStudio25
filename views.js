...
const renderConfigPage = (protocol, host, query, manifest) => {
    ...
    // Check if an access code was provided and is correct
    const accessCodeCorrect = query.access_code === process.env.ACCESS_CODE;
    const contentVisible = showConfigFields && accessCodeCorrect;
        ...
        <body>
            <div class="content">
                ...
                <div class="config-form">
                    ...
                    <form id="accessForm" onsubmit="checkAccessCode(event)">
                        <label>Código:</label>
                ...
                <script>
                    ...
                    function checkAccessCode(event) {
                        ...
                        window.location.href = \`\${currentUrl}?access_code=\${accessCode}\`;
                    }
                </script>
            </div>
