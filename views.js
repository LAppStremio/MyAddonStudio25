...
<body>
            <div class="content">
                ...
                <div style="${(contentVisible && showConfigFields) ? '' : 'display: none;'}">
                ...
                <script>
                    ...
                    // Sobrescreve a função original para remover o código de acesso do URL
                    function updateConfig(event) {
                        event.preventDefault();
                        const form = document.getElementById('configForm');
                        const formData = new FormData(form);
                        const params = new URLSearchParams(formData);
                        params.delete('access_code'); // Esta é a linha que corrige o problema
